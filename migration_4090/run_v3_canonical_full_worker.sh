...
DATA=migration_4090/results/xhand_targeted_pose_search_v3/baseline_canonical.pt
OUT=migration_4090/results/xhand_targeted_pose_search_v3/canonical_full_all
mkdir -p "$OUT"
for ((i=START; i<END; i++)); do
  ...
  "$ISAAC" migration_4090/validate_xhand_fullbody_isaac.py \
    ...
    --modes both --density 100 --friction 2.0 --hand-close-scale 1.05 --closure-mode teleport \
