...
source_vis=${SOURCE_VIS:-migration_4090/derived/source_vis_bleach_source0.pt}
output=${OUTPUT_DIR:-$repo/graph_exp/bimanual_data/4090_irregular_bleach_baseline_source0_v6}
log=${LOG_PATH:-$repo/migration_4090/logs/irregular_bleach_baseline_source0_v6.log}
