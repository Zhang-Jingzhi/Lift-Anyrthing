...
root="$repo/graph_exp/bimanual_data/4090_irregular_bleach_baseline_source4_candidates06_strict_minlinks1_v20/contact_capture_v22"
log="$repo/migration_4090/logs/baseline_bleach_contact_capture_v22.log"
