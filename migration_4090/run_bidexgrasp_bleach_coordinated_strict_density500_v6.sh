...
export OUTPUT_DIR="$repo/graph_exp/bimanual_data/4090_irregular_bleach_bidexgrasp_coordinated_strict_density500_v6"
export LOG_PATH="$repo/migration_4090/logs/bidexgrasp_bleach_coordinated_strict_density500_v6.log"
