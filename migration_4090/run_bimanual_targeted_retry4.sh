...
log="$repo/migration_4090/logs/bimanual_generation_smoke_targeted_retry4.log"
output="$repo/graph_exp/bimanual_data/4090_smoke_cylinder_xlarge_source14_targeted_retry4"
