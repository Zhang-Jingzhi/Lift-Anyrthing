...
output="$repo/graph_exp/bimanual_data/4090_irregular_bleach_sample_v4_sources0_4_cached"
log="$repo/migration_4090/logs/irregular_bleach_sample_v4_sources0_4_cached.log"
