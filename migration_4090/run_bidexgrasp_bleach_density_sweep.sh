...
input="$repo/graph_exp/bimanual_data/4090_irregular_bleach_bidexgrasp_strict_v1/ycb__bleach_cleanser/isaac_both_chunks/00000_00001"
output="$repo/migration_4090/results/bidexgrasp_bleach_density_sweep_v1"
main_log="$repo/migration_4090/logs/bidexgrasp_bleach_density_sweep_v1.log"
...
for density in 100 250 500 1000; do
