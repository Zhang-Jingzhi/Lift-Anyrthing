...
OUTROOT="migration_4090/results/xhand_wristorient_ik_v1/phys"
mkdir -p "$OUTROOT" "migration_4090/logs/xhand_wristorient_ik_v1/phys"
...
conda run --prefix /media/home/zhangjingzhi/.tro_grasp_tools/miniforge3/envs/isaac \
  ...
  --dataset migration_4090/results/xhand_wristorient_ik_v1/candidates_orient.pt \
