...
output="$repo/graph_exp/bimanual_data/4090_irregular_piggy_bank_sample_v2_sources0_4"
log="$repo/migration_4090/logs/irregular_piggy_sample_v2_sources0_4.log"
