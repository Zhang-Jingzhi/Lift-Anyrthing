...
log="$repo/migration_4090/logs/bidexgrasp_bleach_candidate_generation_smoke_v2.log"
...
"$conda_root/bin/conda" run --no-capture-output -n tro \
  ...
  --friction 1 \
  --seed 20260805 \
  --output migration_4090/derived/source_vis_bleach_bidexgrasp_candidates_v1.pt \
  --audit-json migration_4090/results/bidexgrasp_bleach_candidate_audit_v1.json
