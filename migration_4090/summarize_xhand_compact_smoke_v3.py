#!/usr/bin/env python3
"""Summarize the final fresh-root twelve-combination XHand smoke test."""
...
PHYS = ROOT / "migration_4090/results/xhand_compact_6x100_v3_smoke/physics"
...
def main():
    ...
    for method in METHODS:
        for obj in OBJECTS:
            ...
            rows.append(row)
    payload = {
        "schema": "xhand_compact_12way_smoke_progress_v3",
