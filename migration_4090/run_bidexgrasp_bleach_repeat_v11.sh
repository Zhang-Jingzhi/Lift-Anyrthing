...
output="$repo/graph_exp/bimanual_data/4090_irregular_bleach_bidexgrasp_standoff_strict_density260_minlinks2_v9/repeat_verified_v11"
log="$repo/migration_4090/logs/bidexgrasp_bleach_repeat_v11.log"
